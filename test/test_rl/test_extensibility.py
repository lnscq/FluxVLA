...
from fluxvla.rl.bridge.flow_policy import FlowPPOPolicyMixin
from fluxvla.rl.policy_specs import (POLICY_SPECS, checkpoint_resolver_for,
                                     get_policy_spec)
...
def test_registration_metadata_is_lazy():
    code = '''
import sys
import fluxvla.rl.policy_specs
import fluxvla.rl.rlinf_registry
assert 'rlinf' not in sys.modules
assert 'fluxvla.rl.bridge.pi05_policy' not in sys.modules
assert 'fluxvla.rl.bridge.smolvla_policy' not in sys.modules
'''
