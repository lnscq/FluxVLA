...
def main():
    ...
    critical = ('fluxvla/rl/models/', 'fluxvla/rl/benchmarks/',
                'fluxvla/rl/utils/', 'fluxvla/rl/workers/rollout.py',
                'fluxvla/rl/workers/env.py',
                'fluxvla/rl/benchmarks/robotwin/env.py',
                'fluxvla/rl/benchmarks/robotwin/runtime.py',
                'fluxvla/rl/eval.py')
