...
class PolicySpec:
    ...
    builder: str = 'fluxvla.rl.bridge.builder.build_flow_policy'
...
POLICY_SPECS = {
    ...
    for spec in (
        PolicySpec(
            ...
            policy_class='fluxvla.rl.bridge.pi05_policy.FluxPI05RLPolicy',
            horizon_config_key='n_action_steps',
            observation_adapters=('libero', 'robotwin'),
            checkpoint_resolver=(
                'fluxvla.rl.bridge.pi05_checkpoint.resolve_candidates'),
        ...
        PolicySpec(
            ...
            policy_class=(
                'fluxvla.rl.bridge.smolvla_policy.FluxSmolVLARLPolicy'),
