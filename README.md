...
| FluxVLA(DiT4DiT)                 |                                                          99.60                                                          |                                                          99.20                                                          |                                                         99.60                                                         |                                                         96.20                                                         | [98.65](https://huggingface.co/limxdynamics/FluxVLAEngine/tree/main/dit4dit_libero_all_full_finetune_bs256)  |

#### RoboCasa GR1

| Model                 | Training Data                     | Cabinet | Drawer | Microwave | Generalization | Average                                                                                                                                 |
| --------------------- | --------------------------------- | ------- | ------ | --------- | -------------- | --------------------------------------------------------------------------------------------------------------------------------------- |
| FluxVLA(SmolVLA)      | 24 tasks, full data (frozen VLM)  | 12.50%  | 10.00% | 17.50%    | 7.22%          | [8.75% (50 trials)](https://huggingface.co/limxdynamics/FluxVLAEngine/tree/main/smolvla_robocasa_full_data_finetune_freeze_vlm_bs512)   |
| FluxVLA(Cosmos3 Nano) | 24 tasks, full data (pure vision) | 46.00%  | 39.00% | 40.00%    | 41.67%         | [41.67% (50 trials)](https://huggingface.co/limxdynamics/FluxVLAEngine/tree/main/cosmos3_nano_robocasa_full_data_full_finetune_bs2048)  |
| FluxVLA(GR00T N1.5)   | 24 tasks, 30 demos                | 22.7%   | 35.7%  | 32.5%     | 48.9%          | [44.3%(50trials)](https://huggingface.co/limxdynamics/FluxVLAEngine/tree/main/gr00t_eagle_3b_robocasa_gr1_24x30_finetune_bs64)          |
| FluxVLA(GR00T N1.7)   | 24 tasks, full data               | 53.00%  | 51.00% | 47.00%    | 45.11%         | [46.42% (50 trials)](https://huggingface.co/limxdynamics/FluxVLAEngine/tree/main/gr00t_n17_native_robocasa_full_finetune_bs512)         |
| FluxVLA(FastWAM)      | 24 tasks, full data               | 55.00%  | 47.00% | 47.00%    | 50.00%         | [49.92% (50 trials)](https://huggingface.co/limxdynamics/FluxVLAEngine/tree/main/fastwam_robocasa_full_data_full_finetune_bs256)        |
