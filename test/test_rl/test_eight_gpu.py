...
def test_budget_stop_validates_unscheduled_last_checkpoint(
    ...
    from fluxvla.rl.pilot_runner import PilotBudgetStop, RoboTwinPilotRunner
    ...
    monkeypatch.setattr(EmbodiedRunner, '_maybe_eval_and_checkpoint',
                        lambda self, step: {})
    runner = object.__new__(RoboTwinPilotRunner)
    ...
    with pytest.raises(PilotBudgetStop):
...
def test_actual_accumulated_forward_is_audited(monkeypatch):
    ...
    from fluxvla.rl.actor_worker import AuditedEmbodiedActor
